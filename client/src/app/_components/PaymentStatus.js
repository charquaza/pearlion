...
import styles from '../_styles/PaymentStatus.module.css';
      ...
      status 
         ?
            <div className={styles['payment-status']}>
               <div className={styles['status-icon']} style={{backgroundColor: STATUS_CONTENT_MAP[status].iconColor}}>
                  {STATUS_CONTENT_MAP[status].icon}
               </div>
               <h2 id='status-text'>{STATUS_CONTENT_MAP[status].text}</h2>
               {intentId && <div className={styles['details-table']}>
                  <table>
                     <tbody>
                        <tr>
               ...
               {intentId && <a href={`https://dashboard.stripe.com/payments/${intentId}`} className={styles['view-details']} rel='noopener noreferrer' target='_blank'>View details
               ...
               <a className={styles['retry-button']} href='/checkout'>Test another</a>
            </div>
         :
            <p>Processing...</p>
   );
